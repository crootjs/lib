...
- **Use `.min.js` in production** — jsDelivr auto-minifies any file on request via Terser, even though no `.min.js` is committed to this repo: `.../lib@0.0.7/api.min.js`. Use the unminified `.js` only when actively reading/debugging.
